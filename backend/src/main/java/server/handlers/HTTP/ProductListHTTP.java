 ...
 */
public class ProductListHTTP {
  
  public static SneakerData getProductList(String productName)  throws Exception{

    try {
        // Compose URL
        URL request = new URL("https://sneakers-real-time-pricing.p.rapidapi.com/sneakers?extended=true&name="+productName);
        ...
        if (urlConnection.getResponseCode() == 200) {
            ...
            return moshi.adapter(SneakerData.class).fromJson(strResponse);
        }
      ...
      throw new Exception("Error while retrieving sneader data (Product List): " + e.getMessage());
    }
  }
  /**
